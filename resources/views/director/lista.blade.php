        ...
        <div
            ...
            <div class="p-4 sm:p-5">
                ...
                <ul class="text-sm text-gray-200 mb-4 space-y-1">
                    <li><strong>Nombre: </strong>{{ $director->nombre }}</li>
                    <li><strong>Nacionalidad: </strong>{{ $director->nacionalidad }}</li>
                    <li><strong>Cantidad de peliculas: </strong>{{ $director->cantidad_peliculas_dirigidas }}</li>
                </ul>
                <button
