            ...
            @foreach ($cines as $cine)
                <div
                    ...
                    <div class="p-0 sm:p-3">
                        <h2 class="text-xl sm:text-2xl font-semibold text-white mb-2">{{ $cine->nombre }}</h2>
                        <div class="text-white text-xs font-bold px-2 py-1 rounded-full inline-block mb-3">
                            {{ $cine->direccion }}
                        </div>
                        ...
                        <p class="text-sm sm:text-base text-gray-300 mb-1 leading-relaxed p-0 ">
                            <span>Salas: </span>{{ $cine->salas->count() }}
                        </p>
